...
def get_news(country, category):
    ...
    get_news_url = 'http://newsapi.org/v2/top-headlines?country={}&category={}&apiKey=7e7f4b54c51d48dab9fecfba7f6def6e'.format(country, category, api_key)
...
def news_from_source(source_id):
    ...
    get_url = 'http://newsapi.org/v2/everything?sources={}&pageSize=30&apiKey=7e7f4b54c51d48dab9fecfba7f6def6e'.format(source_id, api_key)
...
def get_sources():
    ...
    get_sources_url = 'https://newsapi.org/v2/sources?country=us&category=general&language=en&apiKey=7e7f4b54c51d48dab9fecfba7f6def6e'.format(api_key)
...
def search_topic(query):
    ...
    Args:
        query
    '''
    search_topic_url = 'https://newsapi.org/v2/everything?q={}&sortBy=relevancy,publishedAt&pageSize=30&apiKey=7e7f4b54c51d48dab9fecfba7f6def6e'.format(query, api_key)
...
def search_from_source(query, source):
    ...
    Args:
        query, source
    '''
    search_topic_url = 'https://newsapi.org/v2/everything?q={}&sortBy=relevancy,publishedAt&pageSize=30&sources={}&apiKey=7e7f4b54c51d48dab9fecfba7f6def6e'.format(query, source, api_key)
    with urllib.request.urlopen(search_topic_url) as url:
        search_topic_data = url.read()
        search_topic_response = json.loads(search_topic_data)
